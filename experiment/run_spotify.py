...
def generate_code(model, requirement, plan):
    plan_text = "\n".join(plan)
    sys_msg = (
        "Write Python code using requests to execute the given API plan against Spotify Web API. "
        "Return only code."
    )
...
def main():
    ...
    p.add_argument("--dataset", default="./experiment/datasets/spotify.json")
    p.add_argument("--spec", default="./experiment/specs/spotify_oas.json")
    p.add_argument("--config", default="./config.yaml")
    p.add_argument("--out", default="./experiment/result/spotify.csv")
